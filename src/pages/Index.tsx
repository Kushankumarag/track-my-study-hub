...
const Index = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 ${isDarkMode ? 'dark bg-gradient-to-br from-gray-900 to-gray-800' : ''}`}>
      {/* Header */}
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Track your performance, stay ahead, and study efficiently with data-driven insights
            tailored for PU and engineering students.
          </p>
